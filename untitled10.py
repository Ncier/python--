...
# data
mnist = input_data.read_data_sets("C:/Users/Administrator/Desktop/深度学习小例子/MNIST_data/", one_hot=True)
...
with tf.name_scope('loss'):
    ...
    tf.summary.scalar('loss11111111111', cost)
# optimizer
...
with tf.Session() as sess:
    sess.run(init)
    train_writer = tf.summary.FileWriter("C:/Users/Administrator/Desktop/log/train",sess.graph)
    test_writer = tf.summary.FileWriter("C:/Users/Administrator/Desktop/log/test",sess.graph)
    # training
    step = 1
    for i in range(100):
        _batch_size = 128
