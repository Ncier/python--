...
def GFinception(x):
    inception_1x1_1 = Conv2D(32,1,border_mode='same',activation='relu',name='inception_3a/1x1',W_regularizer=l2(0.0002))(x)
    inception_3x3_2 = Conv2D(32,1,border_mode='same',activation='relu',name='inception_3a/3x3_reduce',W_regularizer=l2(0.0002))(x)
    inception_3x3_3 = Conv2D(64,3,border_mode='same',activation='relu',name='inception_3a/3x3',W_regularizer=l2(0.0002))(inception_3x3_2)
    inception_5x5_4 = Conv2D(64,3,border_mode='same',activation='relu',name='inception_3a/5x5_reduce',W_regularizer=l2(0.0002))(x)
    inception_5x5_5 = Conv2D(128,5,border_mode='same',activation='relu',name='inception_3a/5x5',W_regularizer=l2(0.0002))(inception_5x5_4)
...
def unetAdd3(classes, input_size, epochs, batch_size, LR,
          Falg_summary=False, Falg_plot_model=False, pretrained_weights = None):
    inputs = Input(input_size)
...
#最底层两个卷积 NO.1
    ...
    conv9 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge9)
    conv9 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
    conv9 = Conv2D(2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name="7777")(conv9)
   # conv10 = Conv2D(1, 1, activation = 'sigmoid')(conv9)
...
#最底层两个卷积NO.2
    conv5_2 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop4_2)
    conv5_2 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv5_2)
    drop5_2 = Dropout(0.5)(conv5_2)
    
    #第一个上采样 和concate
    up6_2 = Conv2D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (1,1))(drop5_2))
    ...
    conv9_2 = Conv2D(2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name="8888")(conv9_2)
...
#最底层两个卷积NO.3
    conv5_3 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop4_3)
    conv5_3 = Conv2D(1024, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv5_3)
    drop5_3 = Dropout(0.5)(conv5_3)
    
    #第一个上采样 和concate
    up6_3 = Conv2D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (1,1))(drop5_3))
    merge6_3 = concatenate([drop4_3,up6_3], axis = 3)
    conv6_3 = Conv2D(512, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge6_3)
    conv6_3 = Conv2D(512, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6_3)
    #第二个上采样 和concate
    up7_3 = Conv2D(256, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv6_3))
    merge7_3 = concatenate([conv3_3,up7_3], axis = 3)
    conv7_3 = Conv2D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge7_3)
    conv7_3 = Conv2D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv7_3)
    #第三个上采样 和concate
    up8_3 = Conv2D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv7_3))
    merge8_3 = concatenate([conv2_3,up8_3], axis = 3)
    conv8_3 = Conv2D(128, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge8_3)
    conv8_3 = Conv2D(128, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8_3)
    #第四个上采样 和concate
    up9_3 = Conv2D(64, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling2D(size = (2,2))(conv8_3))
    merge9_3 = concatenate([conv1_3,up9_3], axis = 3)
    conv9_3 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(merge9_3)
    conv9_3 = Conv2D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9_3)
    conv9_3 = Conv2D(2, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal',name="9999")(conv9_3)
    



    merge_add_3 = concatenate([conv9,conv9_2,conv9_3], axis = 3)

    conv10_3 = Conv2D(1, 1, activation = 'sigmoid')(merge_add_3)
    ...
    model = Model(input = inputs, output = conv10_3)
